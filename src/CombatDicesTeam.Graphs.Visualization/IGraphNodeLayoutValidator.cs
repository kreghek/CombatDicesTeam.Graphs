...
/// <remarks>
/// Used to validate modified layoutand retry to modify. Especially with random-based
/// <see cref="IGraphNodeLayoutTransformer{TNodeLayout}" />.
/// </remarks>
public interface IGraphNodeLayoutValidator<in TNodePayload>
{
    bool Validate(IGraphNodeLayout<TNodePayload> layout,
