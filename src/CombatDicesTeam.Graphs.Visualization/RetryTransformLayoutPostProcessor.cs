...
public sealed class RetryTransformLayoutPostProcessor<TNodePayload> : ILayoutPostProcessor<TNodePayload>
{
    ...
    public RetryTransformLayoutPostProcessor(IGraphNodeLayoutTransformer<TNodePayload> layoutTransformProvider,
        IGraphNodeLayoutValidator<TNodePayload> layoutValidator, int attemptLimit)
    {
